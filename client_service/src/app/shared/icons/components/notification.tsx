...
export const Notification = ({ width = 50, height = 50, ...props }: SVGProps<SVGSVGElement>) => (
  <svg width={width} height={height} viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} >
    ...
    <path d="M26.4414 32.5C26.2949 32.7526 26.0846 32.9622 25.8316 33.1079C25.5786 33.2537 25.2918 33.3304 24.9998 33.3304C24.7078 33.3304 24.4209 33.2537 24.1679 33.1079C23.9149 32.9622 23.7046 32.7526 23.5581 32.5" stroke="#181818" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
